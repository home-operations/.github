...
The following is a set of guidelines for contributing to any [home-operations](https://github.com/home-operations) repository. Individual repos may add or refine these rules in their own `CONTRIBUTING.md`; in that case, the repo-level guide takes precedence over this one.
...
> [!IMPORTANT]
> Repositories under [home-operations](https://github.com/home-operations) do **not** accept pull requests that are fully or predominantly AI-generated. AI tools may be used solely in an assistive capacity.
>
