...
- One more suppresses actionlint's unknown runner label error for `ubuntu-26.04` and `ubuntu-26.04-arm` until [rhysd/actionlint#682](https://github.com/rhysd/actionlint/issues/682) ships in a release.
